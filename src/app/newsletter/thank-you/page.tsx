    ...
    <div className="container max-w-4xl mx-auto px-4 mt-8">
      <div className="mt-14 font-overpass space-y-6">
        ...
        <div className="space-y-4">
          ...
          <p className='md:text-lg text-justify'>Du kannst uns gern noch unterstützen, indem du die Präsentation am 4. März um 16.00 Uhr in der Messe mit deinen Freund:innen teilst. Je mehr Teilnehmer:innen wir sind, desto größer ist die Chance, dass die Stadt ein neues Basketballfeld baut!</p>
        </div>
      </div>
    </div>
  )

  ...
  return (
    <div id="beteiligung" className="container max-w-4xl mx-auto px-4 mt-8">
      ...
      <div className="mt-10 font-overpass space-y-6">
        ...
        <p className='md:text-lg text-justify'>Wir sind eine große und aktive Community. Es ist wichtig, dass wir genau das der Stadt zeigen.</p>
        <p className='md:text-lg text-justify text-transparent bg-clip-text bg-gradient-to-r from-purple-100 to-purple-400 animate-pulse duration-100 delay-100'>
